...
--
-- Table structure for table `ingredient_list_recipe`
--
...
(3, 1, 'user recipe', 'testttt', '11', '11'),
(4, 6, 'new user recipe', 'aaa', 'aaa', 'aaa'),
(5, 2, 'Admin Rec', '11111', '120', '150'),
(6, 1, 'user recipe test', 'test', '11', '11'),
(8, 2, 'ingredients test', 'a', 'a', 'a'),
(10, 1, 'ingredients test1', '1', '1', '1'),
(11, 1, 'ingredients test11', '1', '11', '11');
...
--
-- Indexes for table `ingredient_list_recipe`
--
...
--
-- AUTO_INCREMENT for table `planner_recipe`
--
ALTER TABLE `planner_recipe`
...
--
-- Constraints for table `ingredient_list_recipe`
--
ALTER TABLE `ingredient_list_recipe`
